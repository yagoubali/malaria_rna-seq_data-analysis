# Required tools
- fastqc v 0.11.9 from [Babraham Bioinformatics](https://www.bioinformatics.babraham.ac.uk/projects/fastqc/)
...
mkdir -p datasets/raw_data_qc
qc_base_dir="./datasets/raw_data_qc"


submit_analysis(){
  data_id=$1
  fastqc ${raw_data_dir}/${data_id}/*fastq   --outdir ${qc_base_dir}/${data_id}
}
